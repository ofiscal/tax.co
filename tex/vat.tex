...
For 200 of the roughly 1400 COICOP codes, determining which VAT rate applied proved difficult. However, those codes apply to less than 0.39\% of purchases.
...
Income is highly correlated with age. (See Table \ref{table:age by age decile} and Figure \ref{people:income-by-age}.) Nobody in the first decile of age (0-6 years) was reported to earn an income, and so few in the next (7-12) that the distribution is not very meaningful. Among the other deciles, age and income are very strongly correlated; every age decile except the last (age 64+) lies stricly to the right of every younger cohort.

\begin{table}
  \centering
  \input{"../output/vat-tables/recip-\subsample/age-by-age-decile"}
  \caption{Interpreting age deciles}
  \label{table:age by age decile}
\end{table}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/people/income,by-age-decile.png}
  \caption{CDF of income across individuals by age decile}
  \label{people:income-by-age}
\end{figure}
...
Average household spending is 1.5 million pesos per month. As a fraction of a household's income, that spending ranges from essentially zero to literally infinite, because so many households have zero income. (Just under 50\% of households earn less than 50,000 pesos per month.) To exclude those infinite values, much of this analysis will refer to ``income-earing households'', meaning households which (during the period of observation) received a nonzero income. We will also focus on median or other percentile values, rather than averages -- because while most households spend less than, say, ten times their income per month, some spend thousands of times more than their income, which skews the average.

About 10\% of income-earning households spend less than a fifth of their income. Just over half spend more than their income. The excess spending might be gifts, government transfers, or loans. [[Can we find out?]] See Figure \ref{income households:spending / income}.
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
...
The VAT falls very slightly more on households with an elderly member, defined as someone older than 65. See Figure \ref{income households:vat / income, by elderly}.
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
...
The VAT falls less heavily on households at the extremes of the education distribution. For instance, considering the median: 50\% of households in which the most educated member has at least a university degree pay 0.8\% or less of monthly income to the VAT, and 50\% of households in which the most educated member has less than a primary school education pay 0.4\% or less. The median for other households is 1.1\%. See Figure \ref{income households:vat / income, by max edu}.
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/income-households/VAT-over-income,-by-max-edu.png}
  \caption{CDF of (vat / income) across income-earning households by maximum education level among a household's members}
  \label{income households:vat / income, by max edu}
\end{figure}



\section{Selected figures, redrawn with a logarithmic horizontal axis}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/purchases/logx/quantity.png}
  \caption{CDF of quantity purhcased across purchases}
  \label{purchase:quantity,logx}
\end{figure}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/purchases/logx/value.png}
  \caption{CDF of monthly purchase value across purchases}
  \label{purchase:value,logx}
\end{figure}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/purchases/logx/vat-in-pesos.png}
  \caption{CDF of VAT paid across purchases}
  \label{purchase:vat in pesos,logx}
\end{figure}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/people/logx/income.png}
  \caption{CDF of income across individuals}
  \label{people:income,logx}
\end{figure}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/people/logx/income,by-age-decile.png}
  \caption{CDF of income across individuals by age decile}
  \label{people:income-by-age,logx}
\end{figure}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/households/logx/income.png}
  \caption{CDF of income across households}
  \label{households:income,logx}
\end{figure}

\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-\subsample/income-households/logx/spending-over-income.png}
  \caption{CDF of (spending / income) across households}
  \label{income households:spending / income,logx}
\end{figure}
...
See Table \ref{table:household income by income decile}.
