...
In education, only 5\% indicate having less than a primary education; 45\% indicate having completed primary or secondary and no further; 23\% indicate ``media'', and 22\% indicate having a university education. See Figure \ref{people:education}.
...
The age of the oldest person in a household ranges from 0 [[who are they?]] to 110. Half of households contain somebody over fifty. A quarter of households include someone under 5 years of age, and half include someone under 14. Almost nobody less than 20 years old lives alone. See Figures \ref{households:youngest} and \ref{households:oldest}. The marked concavity in Figure \ref{households:youngest} likely reflects the fact that people between ages 30 and 60 are likely to be living with their children.
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
