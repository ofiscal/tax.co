...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/purchases/quantity.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/purchases/frequency.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/purchases/value.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/purchases/vat-in-pesos.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/people/age.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/people/income.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/people/transactions-per-month.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/households/size.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/households/transactions-per-month.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/households/youngest.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/households/oldest.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/households/max-edu.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/households/income.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/income-households/spending-over-income.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/income-households/VAT-over-income,-by-has-child.png}
...
\begin{figure}[!htbp]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/income-households/VAT-over-income,-by-has-elderly.png}
...
\begin{figure}[h]
  \centering\includegraphics
      [width=0.8\linewidth]
      {../output/vat-pics/recip-1/income-households/VAT-over-income,-by-income-decile.png}
