...
in a developing country characterized by its high levels of inequality [[and informality?]],
...
Few policymakers, voters, or indeed economists, understand both
the economics of taxation
and the intricate and technical features of tax law.
...
Section 4 explains in detail how we calculate effective tax rates,
...
the differences between the latter are relatively limited.
...
in contrast with the days of import substitution industrialization,
when roughly a third of tax revenue came from tariffs.
A tax on personal and corporate wealth that comes and goes with every tax reform
...
we assume that the personal income tax is fully borne by households,
payroll taxes are borne entirely by workers,
excise taxes
...
and corporate income tax is fully borne by the owners of capital.
Moreover, we assume that property taxes are borne by
...
which is a nationally representative survey of 87,201 households
...
\begin{equation}
  t=\frac
  {consumption + capital + payroll + personal + financial + wealth + property}
  {net \; labor \;income +capital \;income + dividends + payroll + pension \;income}
\end{equation}

$consumption$ is payments made for value added taxes on consumption,
...
In cases where other inputs other than fuel are taxed we do the same
...
$Y$, which is reported in the ENPH,
