* TODO test suite
** TODO make single functions out of (nearly) whole files
The test for each file will be long.
...
** TODO make functions that test the nature of a column int he raw data
