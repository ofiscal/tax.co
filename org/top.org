...
** bifurcate model by 2016 and 2018
DONE Add a regime_year parameter.
overview: bifurcate output by year

Remove "strategy" parameter?
Use regime_year in the names of inputs and outputs that depend on it.
  people_4, households, overview
Make build/ subfolders 2018 and 2016.
  Add the following files to each:
    income tax logic.py
    income tax columns.py
...
wealth tax
* TODO retire hypotheticals from Makefiles, scripts, filenames
