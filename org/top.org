* TODO DUE thursday: long-term goals
** document the model
** review the model with team
** test, bugfix the model
** serve the model
** extend the model
* TODO docker
** TODO upload new docker image from laptop
 then download to desktop
...
** TODO set "where got" to "purchase"
