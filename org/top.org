* TODO retire hypotheticals
** keep the "detail" strategy, but make it implicit
** regexes to seek and purge
detail, approx, prop_, strategy
** files to edit
build/purchases_house.py
build/purchases_2_vat.py
build/purchase_sums.py
common/cl_args.py
common/cl_fake.py
* TODO renta gravable ocasional: aggregate things
Compare that section of "income tax.org" to "people_4_income_taxish.py".
This will require changing at least "people_4_income_taxish" and "people/main.py".
* TODO before CB meeting
** aggregate "rentas ocasionales" per "income tax 2016.hs"
** bifurcate model by dian and dane
...
* TODO speed: don't generate purchases_1 with file-origin column
