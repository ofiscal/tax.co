* TODO test suite
** TODO recip-1/buildings.csv is not big enough
...
** TODO ? why are there quantity=0 values in purchases_2_vat_test
Didn't I discard those upstream?
...
** TODO A way to express tight upper or lower bounds would be nice
Some variant of the InRange() object.
This bears especially on purchases_2_vat_test.py
** TODO need a way to delete output if python program fails
