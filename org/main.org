...
** TODO "cesantias" in "ss_schedules.py" should be "cesantias y primas"
** TODO email juan
*** Can one dependent be used for one kind of income, and another for another?
*** The GMF exemption per year.
In some year it was 11.6 million / month.
What was it in 2016, 2017?
** The exemptions applicable to labor and capital income
In the law there are four:  medicina prepagada, mortgage interest payments, and dependents.
...
*** TODO tricky: vehicles and equipment
Do these turn over on average more or less frequently than every 2 years?
...
*** It's like remittances: it counts against the tax-paying threshold but is not taxed.
** (show juan) Are there more applicable SS deductions in income-tax.org?
...
tax = (S - min( S / 5, 2290 uvt)) * 0.1
  where S = sum of all gifts (private or public)
          = P7510S3A1 + P7510S4A1
** remittances: not taxable income, but ...
They can put you over the threshold (1400 uvt / year) that triggers the need to pay taxes. (c.f. the guide, orange text on page 41).
** ignorable
*** special
