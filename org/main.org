* TODO next
** TODO Where the VAT is .19, the VAT burden is (0.19 / 1+0.19)
** Why is household-member part of the purchase data?
** TODO P6207M1 : source of that money is in the questions after it.
ICETEX = government
...
** TODO region : no VAT in San Andres
...
** TODO non-coicop: special cases too
...
*** so omitting purchase!=1 observations won't bias our estimate of VAT
*** it will, however, bias (downward) our estimate of consumption
** These error codes apply to all income and expense variables
*** the error codes
