* TODO safety  (#safe)
** rename contractor|employee -> asalariado|independiente
** TODO python/vat/build/ overlaps ss_contrib
build ought to be a higher category than vat
...
It's also inefficient to use the detail bridge for the const strategy. Ought to use approx instead -- or better, make a data set like prop-2018-11-31, but all 1s.
