...
*** TODO next: clean, summarize disability
*** in persons, create a "(could be claimed as a) dependent" variable
age < 18 => dependent
...
*** data needed for exemptions: disability, student, dependent
*** disability: dodged
**** how we dodged the need to have this
It's basically a redundant category. Any partner or family member who makes less than 260 UVT can be claimed as a dependent.
**** the variables
***** P6310: kind of, not really
