...
Whereas dependents can be strategically split between parents, the GMF deduction can only be strategically used to cover one form of income or another within the same earner; they cannot be shared across earners.
** TODO ponder with Juan
Are there a lot of people with renta presuntiva > actual renta?
(If so, must model.)
** TODO delay the file-taxes-if threshold
** dependent exemption is only for labor income, and only 32 uvt / month
c.f. form 210, p. 3, section "deducciones imputables"
** TODO asking juan
*** Can one dependent be used for one kind of income, and another for another?
*** DONE The GMF exemption per year.
2018 = $11.604.600
2017 = $11.150.650
2016 = $10.413.550
*** DONE what are the "beneficios" subtracted from renta gravable?
**** answer
...
** DONE redo this according to "income tax.hs"
...
** DONE ignorable income variables
*** special
