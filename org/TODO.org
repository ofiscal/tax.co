...
** TODO resume review for questions
in this document, at "accuracy (#right)"
** undescribed variables
directorio, orden, secuencia_encuesta, secuencia_p, cap
** identifiers (unit of observation, linking)
** what does "otros impuestos" include?
...
** one does not need quantity to determine expenditure, right?
** is it possible to determine who in a household made an expenditure?
