...
The one for "used savings" (and maybe "recently bought this house" too)
in households_1_agg_plus_test.py.
It's copied straight from how it was pre-aggregation.
Are both not constant within household?
