...
** propogate new variables to household-level data
** add a "months to save for a month" variable
How long it would take to save the amount of money they use in a month.
** make quantiles for that variable, for a few data frames
*** hh[ hh["recently bought this house"] == 1 ]
*** hh[ hh["used savings"] == 1 ]
*** hh[
