* TODO estimate duration to save a month of expenses
** discard everyone who used savings, or not
Pull in a new person-level variable, P7516:
  "6. Utilizó ... durante los ÚLTIMOS
  12 MESES, ahorros de años
  anteriores en los gastos del
  hogar? 1 » Sí 2 » No 3 » No tiene
  ahorros
** discard anybody who bought a house
*** coicop code 12610104
*** viviendas variable P5102
12. ¿Esta vivienda la compró en
los últimos 12 meses? a1 » Si 2 »
No
** then compute duration
how long it would take to save up the amount of money they use in a month.
* TODO BUG in latest Docker iamge
permission error -- can't create files
...
* TODO possibly wrong
** TODO why do we drop so many people?
people_0 is twice as big as people_1
...
* TODO test suite
** TODO RESUME here
verify that the fix to dependent earners worked --
that now, nobody claimed as a dependent pays taxes
