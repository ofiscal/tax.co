...
GCMUG
*** first compare stats
esp. compare to "income" and "income, cash", and "value, *"
** TODO try new net income, expenditure vars from DANE
*** DONE Import new total income, expense vars at person-level, propogate completely through pipeline.
*** Try running time-to-save using those instead; compare results.
**** See if as many high-savers are poor.
...
*** consider other new DANE variables?
So far I've imported ICMDUG, GCMUG.
  See how by looking at the commit immediately following
   c28b76a6511cdd8f6a2e7e4ebf368c94a94a0dca.
** TODO look at all-elderly households
** TODO archive explanations from Camilo and Camilo
once this is done
...
** Good: if a purchase is not labeled, I call it a purchase.
Camilo Andres Avila Carreño says yes, we should assume that.
...
Camilo Andres Avila Carreño says yeah, there are outliers, use your judgment.
** no-income spending
...
** ENPH
*** "Ingreso \*" and "Gasto total" are obvious
...
* TODO file re. ENPH
** I deleted the "home purchase value" variable
      in commit 5967f198000676bd0107065bb332a4dc9aa9192b
      It was never used.
