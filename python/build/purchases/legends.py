...
freq = {
  ...
  # PITFALL: Note that code 9 implies *less* frequent purchase than code 10.
  # If it weren't for that reversal,
  # frequency would b monotonic in frequency code.
