...
files = [
  ...
  , File( "rural_semanal"
    ...
    , c.variables_with_comma_weight +
      [ ( "NC2R_CA_P3", {VarContent.NotAString}
          , "coicop", 0 )
      , ( "NC2R_CA_P4_S1", {VarContent.HasNull, VarContent.Comma, VarContent.Digits}
          , "quantity", 0 )
      , ( "NC2R_CA_P5_S1", {VarContent.NotAString}
          , "how-got", 0 )
      , ( "NC2R_CA_P6_S1", {VarContent.NotAString}
          , "where-got", 0 )
      , ( "NC2R_CA_P7_S1", {VarContent.NotAString}
          , "value", 0 )
      , ( "NC2R_CA_P8_S1", {VarContent.NotAString}
          , "freq", 0 ) ]
    , c.corrections
  )
  ...
  , File( "rural_semanal_fuera"
    ...
    , c.variables_with_comma_weight +
      ...
      , ( "NH_CGPRCFH_P2"  , {VarContent.NotAString}, "quantity", 0 )
  ...
  , File( "urban_diario_fuera"
    ...
    , c.variables_with_comma_weight +
      ...
      , ( "NH_CGDUCFH_P2", {VarContent.Comma, VarContent.Digits} , "quantity", 0 )
  ...
  , File( "urban_diario_personal"
    ...
    , c.variables_with_comma_weight +
      ...
      , ( "NC4_CC_P2",  {VarContent.Comma, VarContent.Digits}
          , "quantity", 0 )
  ...
  , File( "urban_personal_fuera"
    ...
    , c.variables_with_comma_weight +
      ...
      , ( "NH_CGPUCFH_P2", {VarContent.Comma, VarContent.Digits}
          , "quantity", 0 )
