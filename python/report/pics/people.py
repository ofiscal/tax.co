...
if True: # single series
  plt.close()
  single_cdf( people["age"], "CDF of age across individuals")
  ...
  if True: # income, logx and normal
    plt.close()
    single_cdf( people["income"], "CDF of income across individuals",
                xmin = 10**5, xmax = 4e6 )
  ...
  plt.close()
  single_cdf( people["transactions"],
