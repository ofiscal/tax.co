...
if True: # short-circuit the vat-code keys; set everything to 19
  common_vat = 0.17
  vat_cap_c[ "vat, min"] = common_vat
  vat_cap_c[ "vat, max"] = common_vat
  vat_coicop["vat, min"] = common_vat
  vat_coicop["vat, max"] = common_vat
